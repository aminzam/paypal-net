...
namespace Paypal.Net.Sdk.Messages.Validation {
  ...
  public class CertificateManager {
    ...
    /// </summary>
    private readonly ConcurrentDictionary<string, X509Certificate2Collection> _certificates;
      ...
      if (!_certificates.ContainsKey(certUrl)) {
        ...
        foreach (var result in results) {
          ...
          if (!string.IsNullOrEmpty(trimmed)) {
            ...
            var certificate = new X509Certificate2(Convert.FromBase64String(trimmed));
        ...
        _certificates[certUrl] = collection;
      }
    ...
    public X509Certificate2 GetTrustedCertificateFromFile() {
      ...
      Stream? resourceStream = assembly.GetManifestResourceStream("Synthiam.Web.Resources.DigiCertSHA2ExtendedValidationServerCA.crt");
